...
export const WhatsAppButton = () => {
  ...
  const defaultMessage = encodeURIComponent(
    "Halo MA AL-GHAZALI, saya ingin mendapatkan informasi mengenai sekolah dan PPDB."
  );
  ...
  return (
    <div className="fixed bottom-6 right-6 z-40 flex items-center gap-3">
      ...
      {showTooltip && (
        <div className="hidden sm:flex items-center gap-2 pl-3.5 pr-2 py-2 rounded-2xl bg-[#03241b] border border-gold-400/40 text-slate-100 shadow-xl backdrop-blur-md animate-float-medium">
          <div className="flex flex-col text-left">
            <span className="text-[11px] font-bold text-gold-400 leading-tight">Tanya MA AL-GHAZALI</span>
      ...
      <a
        ...
        aria-label="Tanya MA AL-GHAZALI di WhatsApp"
      >
        {/* Pulsing rings */}
